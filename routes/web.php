...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('/product/detail/store/{product}', 'App\Http\Controllers\ProductController@store_detail')->name('product.store_detail');
    Route::get('/product/detail/update/{product}', 'App\Http\Controllers\ProductController@update_detail')->name('product.update_detail');
